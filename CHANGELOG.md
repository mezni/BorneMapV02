...
| ------- | -------------- | ------------- | ------ |
| v0.1.15 | Retrieval      | Implement answer | In Progress |
| v0.1.14 | Retrieval      | Implement reranker | In Progress |
...
- _In progress — implement answer._

## v0.1.14 (2026-09-14)

### Added

- _In progress — implement reranker._
